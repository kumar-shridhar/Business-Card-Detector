...
parser.add_argument('--widen_factor', default=100, type=int, help='width of model')
parser.add_argument('--dropout', default=0.3, type=float, help='dropout_rate')
parser.add_argument('--dataset', default='business_cards', type=str, help='dataset = [business_cards]')
...
if(args.dataset == 'business_cards'):
    print("| Preparing dataset...")
    sys.stdout.write("| ")
    trainset = torchvision.datasets.ImageFolder(root='./data', transform=transform_train)
    testset = torchvision.datasets.ImageFolder(root='./data', transform=transform_test)
    num_classes = 2
    inputs=3
